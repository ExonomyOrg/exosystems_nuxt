<template>
  <div class="github-dashboard">
    ...
    <div v-else class="dashboard-content">
      <GithubNavbar :selectedRepo="selectedRepo" :contributions="contributions"
        @update:selectedRepo="updateSelectedRepo" :assignedIssues="assignedIssues" :user="user" />
    </div>
  </div>
</template>
...
.header-content h1 {
  margin-right: 1rem;
  /* Space between header text and dropdown */
  font-size: 1.5rem;
...
.repo-dropdown option {
  ...
  background-color: #494646;
  /* Ensure options match dropdown background */
  color: #7bcbed;
...
.repo-dropdown option:hover {
  background-color: #3e3e3e;
  /* Change background color on option hover */
}
...
.home-button img {
  ...
  /* Add smooth transitions for hover */
}
